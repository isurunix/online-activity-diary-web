  ...
  <body>
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">Online Activity Diary</a>
      </div>

      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="index.php">Home</a></li>
          <li class="active"><a href="profile-settings.php">Settings</a></li>
          <li><a href="sign-in.php">Sign out</a></li>
        </ul>
      </div>
    </div>
    <!-- navbar end -->
    ...
    <div class="container settings-body">
      <div class="row">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2">
          ...
          <form action="notification-settings.php">
